...
create_environment:
	$(PYTHON_INTERPRETER)$(PYTHON_VERSION) -m venv env_$(PROJECT_NAME)

activate_environment:
	@echo "\033[1;31mUnfortunately, it is not possible to activate the environment directly from Makefile, so please run:\033[0m"
	@echo "\033[1m\nsource env_$(PROJECT_NAME)/bin/activate\033[0m"
